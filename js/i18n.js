...
const translations = {
  "You’re invited": "诚邀您参加",
  "TeenLaunch is Launching!": "TeenLaunch 正式启航！",
  "Join us as we officially launch TeenLaunch. Discover opportunities, connect with others and kickstart your journey.": "欢迎参加 TeenLaunch 正式发布会。探索机会、结识伙伴，开启你的成长旅程。",
  "Register for Launch Event": "报名参加发布会",
  "Luma registration link coming soon": "Luma 报名链接即将开放",
  "Launch event ticket categories": "发布会票种",
  "STUDENTS": "学生",
  "FREE": "免费",
  "For the young people TeenLaunch is built to support.": "面向 TeenLaunch 致力支持的年轻人。",
  "MEDIA · KOL": "媒体 · 意见领袖",
  "For media guests and key opinion leaders covering the launch.": "面向报道本次发布会的媒体嘉宾与意见领袖。",
  "VIP · INVESTOR / ENTREPRENEUR": "贵宾 · 投资者 / 企业家",
  "For adult investors and entrepreneurs joining the launch.": "面向参加发布会的成年投资者与企业家。",
  "Registration will be handled securely through Luma.": "报名将通过 Luma 安全办理。",
  "Exclusive for launch attendees": "发布会参与者专享",
  "🎁 Get Your TeenLaunch Launch Goodie Bag": "🎁 领取 TeenLaunch 发布会专属礼品袋",
  "Get Your TeenLaunch Launch Goodie Bag": "领取 TeenLaunch 发布会专属礼品袋",
  "Register and join us to receive exclusive TeenLaunch goodies made to help you discover, plan and launch your next step.": "立即报名并参与活动，领取 TeenLaunch 专属礼品，助你探索方向、规划行动，开启下一步。",
  "TeenLaunch Launch Goodie Bag illustration showing a tote bag, Launchpad notebook, bookmark front and back, and Career DNA sticker sheet": "TeenLaunch 发布会礼品袋展示图，包括帆布袋、Launchpad 笔记本、书签正反面及职业 DNA 贴纸",
  "TeenLaunch Tote Bag": "TeenLaunch 帆布袋",
  "Launchpad Notebook": "Launchpad 笔记本",
  "Bookmark": "书签",
  "Career DNA Stickers": "职业 DNA 贴纸",
  "Welcome back": "欢迎回来",
  "Your next step starts here": "你的下一步从这里开始",
  "What could your future look like?": "你的未来会是什么模样？",
  "You do not need to have it all figured out. Discover what excites you, find a real opportunity, and grow one step at a time.": "你不必现在就想清楚一切。发现让你心动的方向，找到真实机会，一步一步成长。",
  "Continue my journey": "继续我的旅程",
  "Personalise my journey": "定制我的旅程",
  "Browse all opportunities": "浏览所有机会",
  "Free to explore": "免费探索",
  "Made for young people": "为年轻人打造",
  "Start in minutes": "几分钟即可开始",
  "TeenLaunch journey preview": "TeenLaunch 成长旅程预览",
  "YOUR JOURNEY": "你的旅程",
  "One small step can open a new path.": "小小一步，也能开启一条新路。",
  "Know yourself": "认识自己",
  "Try something real": "参与真实实践",
  "Show how you grew": "展现你的成长",
  "There is no single “right” path. Let’s find one that feels like you.": "人生没有唯一的“正确”道路。让我们找到一条真正适合你的路。",
  "Find what excites you": "发现令你心动的方向",
  "What sounds fun right now?": "现在什么最吸引你？",
  "Pick a direction. You can always change your mind.": "先选择一个方向；你随时都可以改变想法。",
  "Compete": "参加比赛",
  "Challenges and contests": "挑战与竞赛",
  "Make an impact": "创造影响",
  "Community and service": "社区与服务",
  "Create": "动手创造",
  "Workshops and building": "工作坊与实践",
  "Explore careers": "探索职业",
  "Internships and exposure": "实习与职业体验",
  "Not sure yet": "还不确定",
  "Discover my Career DNA": "探索我的职业 DNA",
  "Picked for you": "为你精选",
  "Start exploring": "开始探索",
  "Good next steps, not endless choices.": "找到合适的下一步，不必困在无尽选择中。",
  "Recommendations shaped by your profile and Career DNA.": "根据你的个人资料与职业 DNA 提供专属推荐。",
  "A few current opportunities to help you begin.": "从这些近期机会开始行动。",
  "See all opportunities": "查看所有机会",
  "Finding fresh opportunities for you…": "正在为你寻找最新机会……",
  "A journey that grows with you": "与你共同成长的旅程",
  "From curious to confident.": "从好奇走向自信。",
  "TeenLaunch keeps discovery, action, and reflection connected.": "TeenLaunch 将探索、行动与反思串联起来。",
  "Discover yourself": "探索自我",
  "Understand your strengths and interests.": "了解你的优势与兴趣。",
  "Start Career DNA →": "开始职业 DNA 测试 →",
  "Choose a next step": "选择下一步",
  "See opportunities that fit who you are.": "查看真正适合你的机会。",
  "View my matches →": "查看我的推荐 →",
  "Try and grow": "尝试并成长",
  "Track applications and real experiences.": "记录申请与真实经历。",
  "Open my journey →": "打开我的旅程 →",
  "Tell your story": "讲述你的故事",
  "Turn what you did into proof of growth.": "把你的经历转化为成长证明。",
  "Build my portfolio →": "创建我的作品集 →",
  "You are not doing this alone": "你并不是独自前行",
  "Stuck? Ask for a little help.": "遇到困难？随时寻求帮助。",
  "Use Career Copilot to compare options, prepare an application, or work out one realistic thing to do next.": "使用职业副驾驶比较选择、准备申请，或找出切实可行的下一步。",
  "Ask Career Copilot": "询问职业副驾驶",
  "Explore resources": "探索资源",
  "Example Career Copilot conversation": "职业副驾驶对话示例",
  "I’m interested in design, but I don’t know where to start.": "我对设计感兴趣，但不知道该从哪里开始。",
  "That’s okay. Let’s find one workshop for beginners that you can try this month.": "没关系。让我们找一个适合新手、这个月就能参加的工作坊。",
  "Your future is yours to explore": "你的未来由你探索",
  "Ready for one joyful next step?": "准备好迈出充满期待的下一步了吗？",
  "Start with what interests you today. TeenLaunch will help with what comes next.": "从今天感兴趣的事开始，TeenLaunch 会陪你走好接下来的每一步。",
  "match": "匹配",
  "Rolling deadline": "滚动截止",
  "TeenLaunch partner": "TeenLaunch 合作伙伴",
  "Opportunity": "机会",
  "Visit official site": "访问官方网站",
  "See if it’s for me": "看看是否适合我",
  "Fresh opportunities are on the way.": "更多新机会即将上线。",
  "Our team is reviewing new options. Explore all opportunities or check back soon.": "我们的团队正在审核新机会。你可以先浏览所有机会，或稍后再来查看。",
  "Explore opportunities": "探索机会",
  "We couldn’t load opportunities right now.": "暂时无法加载机会。",
  "Please try the full Explore page in a moment.": "请稍后前往完整的探索页面重试。",
  "Open Explore": "打开探索页面",
  "External source · Admin reviewed": "外部来源 · 管理员已审核",
  "External Source · Admin Reviewed": "外部来源 · 管理员已审核",
  "TeenLaunch verified": "TeenLaunch 已验证",
  "Verified partner": "已验证合作伙伴",
...
Object.assign(translations, {
  "Explore": "探索",
  "My Journey": "我的旅程",
  "Ask TeenLaunch": "询问 TeenLaunch",
  "Logging out...": "正在退出登录……",
  "TeenLaunch | About": "TeenLaunch | 关于我们",
  "About TeenLaunch": "关于 TeenLaunch",
  "One journey from strengths to experience.": "从认识优势到累积经验的一段成长旅程。",
  "TeenLaunch helps young people understand themselves, find suitable opportunities, gain experience and build a credible portfolio.": "TeenLaunch 帮助年轻人认识自己、寻找合适的机会、累积经验，并建立可信的作品集。",
  "Know yourself": "认识自己",
  "Career DNA makes strengths and interests easier to understand.": "职业 DNA 帮助你更容易了解自己的优势和兴趣。",
  "Find your path": "找到你的方向",
  "Personalised matching turns opportunity discovery into a focused next step.": "个性化推荐帮助你从发现机会走向清晰的下一步。",
  "Build your future": "打造你的未来",
  "Planning and portfolio tools help experience become visible progress.": "规划和作品集工具让你的经历成为看得见的成长。",
  "FAQ": "常见问题",
  "Answers and practical guidance.": "查看解答和实用指南。",
  "Partners": "合作伙伴",
  "Submit opportunities for TeenLaunch review.": "提交机会供 TeenLaunch 审核。",
  "Preparation tools for your next opportunity.": "为你的下一个机会做好准备。",
  "How it works": "使用方式",
  "Read the complete TeenLaunch guide.": "阅读完整的 TeenLaunch 使用指南。",
  "Mobile App Preview": "手机应用预览",
  "Add external opportunity": "添加外部机会",
  "Add internal activity": "添加内部活动",
  "Add opportunity link": "添加机会链接",
  "Expired": "已过期",
  "External opportunity URL": "外部机会网址",
  "Grants": "资助计划",
  "Manual": "手动添加",
  "Only the official link is needed": "只需提供官方网站链接",
  "Partner": "合作伙伴",
  "Pending review": "待审核",
  "Published": "已发布",
  "TeenLaunch internal activity": "TeenLaunch 内部活动",
  "Total applications": "申请总数",
  "URL/AI fetched": "通过网址或 AI 获取",
  "Choose preferred rest days": "选择偏好的休息日",
  "Choose school days and hours": "选择上学日期和时间",
  "Skills & Debate": "技能与辩论",
  "TeenLaunch | My Journey": "TeenLaunch | 我的旅程",
  "Your connected journey": "你的成长旅程",
  "Know yourself. Keep moving forward.": "认识自己，继续向前。",
  "Everything personal is here: your strengths, matches, plans, saved opportunities and applications.": "你的优势、推荐机会、计划、收藏和申请记录都集中在这里。",
  "Your Matches": "你的推荐",
  "Understand your strengths and interests.": "了解你的优势和兴趣。",
  "Discover yourself →": "探索自己 →",
  "See opportunities selected for your profile.": "查看根据你的资料推荐的机会。",
  "View recommendations →": "查看推荐 →",
  "Return to opportunities you are considering.": "返回你正在考虑的机会。",
  "View saved →": "查看收藏 →",
  "Track internal and self-reported registrations.": "查看你通过平台记录的申请。",
  "View applications →": "查看申请 →",
  "Plan deadlines without overwhelming your week.": "轻松规划截止日期，让每周安排更从容。",
  "Open planner →": "打开计划工具 →",
  "Turn experience into evidence of growth.": "把经历转化为成长成果。",
  "Build portfolio →": "创建作品集 →",
  "Practise communication, reasoning and confident speaking.": "练习沟通、推理和自信表达。",
  "Start practising →": "开始练习 →",
  "Platform administration": "平台管理",
  "Review opportunities, partners and registrations.": "查看机会、合作伙伴和申请记录。",
  "Open Admin Dashboard": "打开管理员面板",
...
Object.assign(translations, {
  ...
  "Progress tracking": "进度追踪",
  "Practice time recorder": "练习计时记录器",
  "Record your speaking practice": "记录你的演讲练习",
  "Ready to record.": "准备开始记录。",
  "Start recording": "开始记录",
  "Stop and save": "停止并保存",
  "Today's practice": "今日练习",
  "Sessions recorded": "已记录次数",
  "Recording practice time.": "正在记录练习时间。",
  "Recording resumed.": "已继续记录。",
  "Start the recorder before saving.": "请先开始计时再保存。",
  "Practice session saved.": "练习记录已保存。",
  "Practice streak:": "连续练习：",
  "days": "天",
  "First Speech": "首次演讲",
  "Rebuttal Rookie": "反驳新手",
